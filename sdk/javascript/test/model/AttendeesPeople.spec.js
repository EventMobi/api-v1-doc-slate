...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Eventmobi.AttendeesPeople();
  });
  ...
  describe('AttendeesPeople', function() {
    it('should create an instance of AttendeesPeople', function() {
      // uncomment below and update the code to test AttendeesPeople
      //var instane = new Eventmobi.AttendeesPeople();
      //expect(instance).to.be.a(Eventmobi.AttendeesPeople);
    });
