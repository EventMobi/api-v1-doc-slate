...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Eventmobi.Sections();
  });
  ...
  describe('Sections', function() {
    it('should create an instance of Sections', function() {
      // uncomment below and update the code to test Sections
      //var instane = new Eventmobi.Sections();
      //expect(instance).to.be.a(Eventmobi.Sections);
    });
