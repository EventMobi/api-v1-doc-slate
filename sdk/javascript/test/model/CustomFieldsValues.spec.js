...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Eventmobi.CustomFieldsValues();
  });
  ...
  describe('CustomFieldsValues', function() {
    it('should create an instance of CustomFieldsValues', function() {
      // uncomment below and update the code to test CustomFieldsValues
      //var instane = new Eventmobi.CustomFieldsValues();
      //expect(instance).to.be.a(Eventmobi.CustomFieldsValues);
    });
